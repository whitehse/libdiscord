...
- Support configurable initialization via `discord_config_t` (including event_queue_size, bot_token, gateway_url, api_base_url).
...
- Discord REST helpers: `discord_create_message`, `discord_edit_message`, `discord_delete_message`, `discord_get_channel`
- Gateway helpers: `discord_gateway_connect`, `discord_gateway_send_heartbeat`, `discord_gateway_send_identify`, `discord_gateway_send_resume`
